...
%
%   'filenames' name of the image files
%
...
% [healthy_leaf_modelData, healthy_leaf_testData] = prepare_data_v2(images, filenames, 100, 100, 1);

function [healthy_leaf_modelData, healthy_leaf_testData, filename_leaf_modelData, filename_leaf_testData] = ...
    prepare_data(images, filenames, qtty_leaf_models, qtty_leaf_test, mix)
...
filename_leaf_modelData = filenames(first_image:last_image);
...
filename_leaf_testData = filenames(first_image:last_image);
